function selectCurso() {
  var listaCurso = document.getElementById("cursos");
  var cursoSelecionado =
    listaCurso.options[listaCurso.selectedIndex].textContent;

  var confirmar = confirm(
    "Uma nova página será aberta, deseja abrir o curso " +
      cursoSelecionado +
      "?"
  );
  ...
  if (confirmar) {
    ...
    janela.document.write(
      "<title>Página do Curso " +
        listaCurso.options[listaCurso.selectedIndex].text +
        "</title>"
    );

    switch (listaCurso.selectedIndex) {
      case 1:
        janela.document.writeln(
          "<h1>Análise e Desenvolvimento de Sistemas</h1>"
        );
        janela.document.writeln(
          "<p>O tecnólogo em Análise e Desenvolvimento de Sistemas analisa, projeta, documenta, especifica, testa, implanta e mantém sistemas computacionais de informação. Esse profissional trabalha, também, com ferramentas computacionais, equipamentos de informática e metodologia de projetos na produção de sistemas.</p>"
        );
        break;
      case 2:
      ...
      case 3:
        ...
        janela.document.writeln(
          "<p>O tecnólogo em Fabricação Mecânica atua no segmento de fabricação, envolvendo usinagem, conformação, soldagem, montagem e outros processos mecânicos.</p>"
        );
        break;
      case 4:
        janela.document.writeln(
          "<h1>Gestão Empresarial - Ensino a Distância</h1>"
        );
        janela.document.writeln(
      ...
      case 7:
        ...
        janela.document.writeln(
          "<p>O aluno aprenderá a transformar ambientes de manufatura convencional em ambientes mais tecnológicos. Estruturado por blocos temáticos direcionados a projetos, o conteúdo do curso é dividido em processos de manufatura, eletrônica e automação e áreas multidisciplinares.</p>"
        );
        break;
      case 8:
        janela.document.writeln("<h1>Processos metalúrgicos</h1>");
        janela.document.writeln(
          "<p>O tecnólogo em Processos Metalúrgicos utiliza os fenômenos envolvidos em processos como: tratamentos térmicos, fundição, siderurgia, laminação, forjamento de metais, sinterização e tratamentos de superfície.</p>"
        );
        break;
    }
  }
